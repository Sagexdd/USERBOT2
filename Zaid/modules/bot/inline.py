...
<b> • 𝗨ɴᴋɴᴏᴡɴ𝟽 𝗨sᴇʀʙᴏᴛ :</b> {message.from_user.mention}
...
"""
    answers.append(
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph/file/ae3fcd1ec046c4ea0ad14.jpg",
            input_message_content=InputTextMessageContent(
                msg, parse_mode=ParseMode.HTML, disable_web_page_preview=True
            ),
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton("──「 𝗨ɴᴋɴᴏᴡɴ𝟽 𝗨sᴇʀʙᴏᴛ 」──", callback_data="helper")]]
            ),
        )
    )
    return answers
